...
<p align="center"><img src="image/preview.png" alt="preview" width="500" height="500"></p><br>
...
- Lihat profil akun orang lain. <br>
- Lihat jawaban tugas.<br>
...
- View other people's account profiles.<br>
- View assignment answers.<br>
- Answer assignments & get xp for level.<br>
- View level history.<br>
- Submit account appeal requests.<br>
## <b> The Sobat Gapai Admin Features via Website </b><br>
- User monitoring.<br>
- Ban users.<br>
- Delete user assignments.<br>
- Delete user answers.<br>
